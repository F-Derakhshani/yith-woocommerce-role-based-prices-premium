        ...
        'rules' => array(
            ...
            'fields' => array(
                ...
                'ywcrbp_category_product' => array(
                    ...
                    'type' => 'ywcrbp-ajax-category',
                    'multiple' => true,
                    'std' => array(),
                    'options' => array(),
                    'id' => 'ajax_ywcrbp_category_product',
                    'deps' => array(
                ...
                'ywcrbp_tag_product' => array(
                    ...
                    'desc' => __( 'Select product tags to which the rule applies', 'ywcps' ),
                    'type' => 'ywcrbp-ajax-tag',
                    'multiple' => true,
                    'std' => array(),
                    'options' => array(),
                    'id' => 'ajax_ywcrbp_tag_product',
                    'deps' => array(
                        'ids' => '_ywcrbp_type_rule',
                        'values' => 'tag',
                    ),
                ...
                'ywcrbp_decimal_value' => array(
                    ...
                    'desc' => __( 'Enter a percent value to calculate discount or markup.' ),
                    'type' => 'custom-text',
